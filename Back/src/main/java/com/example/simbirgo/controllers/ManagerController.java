...
import com.example.simbirgo.dto.request.*;
...
public class ManagerController {
    ...
    @PreAuthorize("hasRole('MANAGER') or hasRole('ADMIN') or hasRole('HEAD') ")
    @Transactional
    public ResponseEntity<?> computation(@RequestBody AddressDto address) {
        return computationService.computation(address.getAddress());
    }
}
