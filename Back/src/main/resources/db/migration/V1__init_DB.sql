...
create table calculation (id  bigserial not null, address_object_constractions varchar(255), created_date timestamp, number int4, calculation_state_id int8, manager_id int8, primary key (id));
create table calculation_results (id  bigserial not null, calculation_id int8, result_id int8, primary key (id));
...
create table results (id int8 not null, amount float8, full_price float8, material varchar(255) not null, measurement_unit varchar(255), price float8, calculation_id int8, material_characteristics_id int8, structural_element_frame_id int8, primary key (id));
create table roles (id  serial not null, name varchar(20), primary key (id));
create table status (id int8 not null, name varchar(50), primary key (id));
...
alter table calculation add constraint FKpuklyaadqeh3f5stg68agcdme foreign key (calculation_state_id) references status;
...
alter table calculation_results add constraint FKph6d2okvs72bilppqgpmduytq foreign key (result_id) references results;
...
alter table results add constraint FKef0sr3awkm5cat9raq7h65t83 foreign key (calculation_id) references calculation;
...
alter table results add constraint FKl8vnqwop65lg5ah739v7khac6 foreign key (structural_element_frame_id) references structural_element_frame;
